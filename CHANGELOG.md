...
- Bonus objectives are now assigned to you during each Blind. You may review the upcoming Bonus Objectives for the current blind by hovering the small gray and yellow circles below each blind.
- Up to 2 bonus objectives are available during a Small Blind, up to 3 during a Big Blind and up to 4 during a Boss Blind.
- Track the progress of each goal during a Blind by hovering the gray, green, or yellow circles under the Blind HUD.
- Completing a bonus objective awards loot token cards. Review your current loot tokens at any time on the Loot tab in your Run Info.
  - Here you may discard any unwanted loot tokens, as you may only hold 12 at a time.
- When you are in possession of loot tokens, skip any Blind to immediately claim your loot.
  - Claiming your loot opens a booster pack with all the cards generated by your loot inside.
  - In this special booster pack, any card that can be used may be immediately used, and any card that can be held in one of your cardareas may be immediately taken.
  - Pool rules still apply across your complete set of loot, duplicates cannot appear unless otherwise specified by the loot token or game conditions (Showman).
- Currently, there are 23 bonus objectives (some are fixed, some may have different flavours) and 31 potential reward categories.
  - These include common options such as 6 playing cards, 4 tarot cards or 4 planets.
  - It also includes occasional options, such as 2 spectral cards, guaranteed edition cards (including Baliatro's Photographic and Scenic), or guaranteed rarity jokers.
  - It also rarely includes some run-changing options, such as a legendary joker, a rare negative joker, or a voucher.
- Balancing passes are yet to be done, the amount of objectives, the difficulty of objectives, the amount of loot, and the relative rarity of loot categories are all subject to change.
